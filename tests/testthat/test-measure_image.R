...
test_that("measure_image works", {
  ...
  # snapshot test
  expect_snapshot_value(measure_image(corrpath, plot_image = FALSE), tolerance = 1)
  expect_snapshot_value(measure_image(corrpath, plot_image = FALSE, find_eye = FALSE), tolerance = 1)
